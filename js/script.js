var ui = {
  ...
  headerNav: function() {
    $('header .navbar-collapse ul a, .scrollme').bind('click', function(event) {
...
$(document).ready(function(){
        ...
        if ( !$("html").hasClass("touch") ){
            ...
            if ( !$("body").hasClass("no-animate") ){
                ...
                $('.products-container .item').addClass("no-visible");
                ...
                $('.products-container').viewportChecker({
                    offset: 400,
                    callbackFunction: function(elem, action){
                        $('.products-container .item').addClass('visible animated fadeIn');
                    }
...
// End animation    
        ...
        $('.fancyboxModal').click(function(){
            var carHeader = $(this).data('carheader');
            $('.car-input').val(carHeader);
        });
